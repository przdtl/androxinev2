...
from application.dto.templates.update_template import (
    UpdateTemplateInputDTO,
    DayOfWeek as DayOfWeekDTO,
)
from application.use_cases.templates.update import UpdateTemplateUseCase
...
from presentation.api.v1.schemas.templates.update import (
